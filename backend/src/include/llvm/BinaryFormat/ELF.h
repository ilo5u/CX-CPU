...
// Specific e_flags for Chinx
enum {
  EF_CHINX_NOREORDER = 0x00000001, // do not reorder instructions
  EF_CHINX_PIC = 0x00000002,       // position independent code
  EF_CHINX_ARCH_32 = 0x50000000,   // Chinx32 instruction set per linux not elf.h
  EF_CHINX_ARCH = 0xf0000000       // mask for applying EF_CHINX_ARCH_ variant
};

// ELF Relocation types for Chinx
enum {
