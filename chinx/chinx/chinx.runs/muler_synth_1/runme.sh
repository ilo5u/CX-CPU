...
HD_PWD='C:/Users/livew/Desktop/CX/chinx/chinx/chinx.runs/muler_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log muler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source muler.tcl
