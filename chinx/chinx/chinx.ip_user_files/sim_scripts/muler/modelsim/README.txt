...
#
# Generated by export_simulation on Wed Apr 01 13:45:40 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './muler.sh' script.
...
./muler.sh -noclean_files

For more information on the script, please type './muler.sh -help'.
