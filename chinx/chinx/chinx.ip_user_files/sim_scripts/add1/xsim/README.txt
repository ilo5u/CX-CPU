...
#
# Generated by export_simulation on Wed Apr 01 10:42:17 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './add1.sh' script.
...
./add1.sh -noclean_files

For more information on the script, please type './add1.sh -help'.
